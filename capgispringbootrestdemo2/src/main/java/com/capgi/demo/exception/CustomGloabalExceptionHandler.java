...
public class CustomGloabalExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public void  springHandleNotFound1(HttpServletResponse response) throws Exception{
		response.sendError(HttpStatus.BAD_REQUEST.value(), "Product Not Found......");
	  
	}

	@ExceptionHandler(ProductEmptyException.class) 
	public void  springHandleEmptyFound(HttpServletResponse response) throws IOException{
	  response.sendError(HttpStatus.NOT_FOUND.value(), "List empty......");
	}
